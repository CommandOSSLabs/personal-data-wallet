...
//! - `admin` — `/api/embed`, `/api/ask`, `/api/forget`, `/api/forget/blob`,
//!   `/api/stats`, `/api/restore`, `/health`, `/version`, `/config`
...
pub use admin::{ask, embed, forget, forget_blob, get_config, health, restore, stats, version};
