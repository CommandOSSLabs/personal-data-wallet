...
import type { ClientWithCoreApi, PDWConfig, AccessPermission, Thunk, SealDecryptionOptions } from '../../core/types';
...
export declare class EncryptionService {
     ...
     */
    createSessionKey(userAddress: string, signer?: {
        signPersonalMessageFn?: (message: string) => Promise<{
            signature: string;
        }>;
        keypair?: any;
    }): Promise<SessionKey>;
     ...
     */
    createSealApproveTransaction(userAddress: string, contentOwner: string): Promise<Uint8Array>;
    /**
