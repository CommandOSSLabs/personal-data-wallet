...
class WalletManagementService {
    ...
    deriveContextIdLocal(mainWallet, appId) {
        ...
        const ownerBytes = (0, utils_1.fromHex)(mainWallet.owner.replace('0x', ''));
        const appIdBytes = new TextEncoder().encode(appId);
        const saltBytes = (0, utils_1.fromHex)(mainWallet.contextSalt.replace('0x', ''));
        ...
        const hash = (0, sha3_1.sha3_256)(combined);
        // Return as 0x-prefixed hex address
        return '0x' + (0, utils_1.toHex)(hash);
    }
    /**
