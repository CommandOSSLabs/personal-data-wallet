 ...
 * following the established pattern from GraphService.test.ts
 */
...
describe('KnowledgeGraphManager', () => {
  ...
  beforeEach(() => {
    ...
    mockGraphService = {
      ...
      extractFromMemoriesBatch: jest.fn(),
      addToGraph: jest.fn(),
      findRelatedEntities: jest.fn(),
      queryGraph: jest.fn(),
    } as any;

    graphManager = new KnowledgeGraphManager(mockGraphService);
  });
  ...
  describe('Initialization and Setup', () => {
    test('should initialize with GraphService', () => {
      ...
      expect(graphManager['graphService']).toBe(mockGraphService);
    });
    ...
    test('should get user graph', async () => {
      ...
      expect(mockGraphService.getUserGraph).toHaveBeenCalledWith(userId);
