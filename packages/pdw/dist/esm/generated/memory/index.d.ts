...
export declare const MEMORY_PACKAGE_ID = "0x067706fc08339b715dab0383bd853b04d06ef6dff3a642c5e7056222da038bde";
...
export declare function createMemoryIndex(tx: Transaction, args: CreateMemoryIndexArgs): void;
...
export declare function createMemoryRecord(tx: Transaction, args: CreateMemoryRecordArgs): void;
export declare function convertStringToVector(str: string): Uint8Array;
